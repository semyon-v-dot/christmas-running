...
public class YandexSDK : MonoBehaviour 
{
    ...
    /// <summary> Пользователь открыл рекламу </summary>
    public event Action<int> onRewardedAdOpened;
    /// <summary> Пользователь должен получить награду за просмотр рекламы </summary>
    public event Action<string> onRewardedAdReward;
    /// <summary> Пользователь закрыл рекламу </summary>
    public event Action<int> onRewardedAdClosed;
    /// <summary> Вызов/просмотр рекламы повлёк за собой ошибку </summary>
    ...
    /// <summary> 
    /// Call this to show interstitial ad. Don't call frequently. There is a 3 minute delay 
    /// after each show. 
    /// </summary>
    ...
    /// <summary> Call this to show rewarded ad </summary>
    /// <param name="placement"></param>
    ...
    /// <summary> Callback from index.html </summary>
